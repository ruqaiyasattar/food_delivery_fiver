...
class PageViewModel {
  ...
  TextStyle get titleTextStyle {
    return TextStyle( fontSize: 42.0,fontWeight: FontWeight.w900,fontStyle: FontStyle.italic).merge(this.textStyle);
  }

  TextStyle get bodyTextStyle {
    return TextStyle( fontSize: 24.0).merge(this.textStyle);
  }
}
